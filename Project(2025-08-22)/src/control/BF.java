...
public class BF extends JFrame  {
	...
	public BF() {
		...
		setIconImage(getImage("/Project(2025-08-22)/datafiles/로고1.jpg", 60, 30).getImage());
	...
	public static ImageIcon getImage(String path, int w, int h) {
		return new ImageIcon(new ImageIcon(path.replace("/Project(2025-08-22)", ".")).getImage().getScaledInstance(w, h,
				Image.SCALE_SMOOTH));
	}
	...
	public static void errmes(String t) {
		unsetUI();
		JOptionPane.showMessageDialog(null, t, "경고", JOptionPane.ERROR_MESSAGE);
		setUI();
	}
